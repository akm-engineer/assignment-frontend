...
const Pharma = () => {
  return (
    <div className="container mx-auto text-center mb-8 px-4">
      ...
      <div className="w-full md:w-[1117px] bg-white rounded-lg shadow-lg p-8 md:p-50 pb-32 md:pb-50 pl-8 md:pl-44 pr-8 md:pr-44 flex flex-col md:flex-row items-center relative">
        {/* Video Image */}
        <img
          src={video}
          alt=""
        ...
        <div className="md:ml-8 mt-8 md:mt-0 flex flex-col md:items-start md:justify-center">
          ...
          <h5 className="text-xs md:text-sm text-gray-800 mt-2 md:mt-6 max-w-[400px]">
